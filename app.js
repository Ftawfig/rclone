...
app.factory('posts', 
    [function() 
    {
        ...
        //Test posts
        o.posts = [
            {title: 'Youtube', points: 52, link: "http://www.youtube.com", comments: []},
            {title: 'Reddit', points: 4, link: "http://www.reddit.com", comments: []},
            {title: 'Google', points: 1977, link: "http://google.com", comments: []},
            {title: 'post 4', points: 42, comments: []},
            {title: 'post 5', points: 47, comments: []}
        ];
